...
try:
    if __import__('02_UserLogin.result_login')  == "success":
        ...
        for uploaded_file in uploaded_files:
            if uploaded_file is not None:
                ...
                json_df = df.to_json()
                file_details1 = {"_id": uuid.uuid4().hex, "File Name": uploaded_file.name,
                                 "File Size": uploaded_file.size,
                                 "File Tags": filetags}
                file_details = {"_id": uuid.uuid4().hex, "File Name": uploaded_file.name,
                                "File Size": uploaded_file.size,
            ...
            st.write(
                "Please note that you see default dataframe in the beginning. This dataframe will be restored as soon as your selection is done.")
            st.write(df_1)
    ...
    st.warning("Make sure to login or register before uploading data")
